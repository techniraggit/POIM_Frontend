                                            ...
                                            rows.map((purchase, index) => {
                                                return <tr key={index}>
                                                    ...
                                                    <td className="td-icon-color">
                                                        ...
                                                        {purchase.po_type === 'subcontractor' && purchase.signed_contract?.length > 0 && <DownloadOutlined onClick={() => handleDownload(purchase.po_id, purchase.signed_contract[0].contract_file?.split('/')[purchase.signed_contract[0].contract_file?.split('/').length - 1])} />}
                                                    </td>
                                                </tr>
                                            })
                                        ) : (
